...
<t:layout title="Anasayfa">
    ...
    <div class="error">
        <div class="container-floud">
            <div class="col-xs-12 ground-color text-center">
                ...
                <h2 class="h1">${errMsg}</h2>
                <h5>You can redirect home by <a href="<c:url value="/" />">this link</a></h5>
            </div>
        </div>
    </div>
    <!-- Error Page -->
    ...
    <script>
        ...
        loop3 = setInterval(function () {
            ...
            if (i > 40) {
                clearInterval(loop3);
                selector3.textContent = ${fn:substring(response, 0, 1)};
            } else {
        ...
        loop2 = setInterval(function () {
            ...
            if (i > 80) {
                clearInterval(loop2);
                selector2.textContent = ${fn:substring(response, 1, 2)};
            } else {
        ...
        loop1 = setInterval(function () {
            ...
            if (i > 100) {
                clearInterval(loop1);
                selector1.textContent = ${fn:substring(response, 2, 3)}
                ;
            } else {
